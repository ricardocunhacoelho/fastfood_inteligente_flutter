...
//   var viagem = true;
  // final precoTotal = MostrarPrecoEntrada();
  // late List<ProdutoEntidade> lista;
//   @override
//   Widget build(BuildContext context) {
    // final produtobloc = context.watch<ConfiguracoesProdutoBloc>();
    // final produtostate = produtobloc.state;
...
//           children: [
            ...
            //                   children: [
            //                     Text(
            //                         '${produto.quantidade} - ${produto.titulo}'),
            //                     const Text('-------------'),
            //                     Text('${produto.preco * produto.quantidade}'),
            //                   ],
            //                 ),
            //               SizedBox(
            //                 height: 20,
...
//       actions: <Widget>[
        ...
        //               //     .add(FinalizarPedidoConfiguracoesEventos(produto));
        //               // Navigator.pop(context);
        //             },
        //             child: Text('Imprimir')),
        //       ),
